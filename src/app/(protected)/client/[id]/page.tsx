    ...
    if (!client) {
        return (
            <div className="text-center py-12">
                <Text variant="h4">Cliente não encontrado</Text>
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <div className="flex items-center gap-3">
                            <Text variant="h3" className="text-gray-900">{client.name}</Text>
                ...
                <div className="lg:col-span-1 space-y-6">
                    <Card className="p-6 bg-white border border-gray-100 shadow-sm overflow-hidden">
                        <div className="flex flex-col items-center text-center space-y-4">
                            ...
                            <div>
                                <Text variant="h4" className="text-gray-900">{client.name}</Text>
                                <Text variant="small" className="text-gray-500 uppercase tracking-wider font-semibold">Cliente</Text>
                            </div>
                        </div>
                        ...
                        <div className="mt-8 space-y-4">
                            ...
                            <div className="flex items-center gap-3 text-gray-600">
                                ...
                                <span className="text-sm">Membro desde {format(new Date(client.createdAt), 'MMMM yyyy', { locale: ptBR })}</span>
                            </div>
                            <div className="flex items-center gap-3 text-gray-600">
                                <ShieldCheck className={`h-4 w-4 ${client.isVerified ? 'text-green-500' : 'text-gray-300'}`} />
                                <span className="text-sm">{client.isVerified ? 'Conta Verificada' : 'Aguardando Verificação'}</span>
                            </div>
                        </div>
                    </Card>
                        ...
                        {client.asaasCustomerId ? (
                            <div className="space-y-4">
                                <div className="p-3 bg-green-50 border border-green-100 rounded-lg flex items-center gap-3">
                                    ...
                                    <div>
                                        <p className="text-sm font-medium text-green-800">Cliente Integrado</p>
                                        <p className="text-xs text-green-600">ID: {client.asaasCustomerId}</p>
                                    </div>
                                </div>
                                <Text variant="small" className="text-gray-500">
                                    Este cliente já está sincronizado com o gateway de pagamentos.
                                </Text>
                            </div>
                        ) : (
                            <div className="space-y-4">
                                <div className="p-3 bg-yellow-50 border border-yellow-100 rounded-lg flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-yellow-600">Nenhum ID gerado ainda</p>
                                    </div>
                                </div>
                                <Text variant="small" className="text-gray-500">
                                    O ID do Asaas será gerado automaticamente quando o cliente realizar o primeiro pagamento.
                                </Text>
                            </div>
                        )}
                    </Card>
                    ...
                    <Card className="bg-white border border-gray-100 shadow-sm overflow-hidden">
                        <div className="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
                            <div className="flex items-center gap-2">
                                ...
                                <Text variant="h4" className="text-gray-900">Endereços Cadastrados</Text>
                            </div>
                        ...
                        <div className="p-6">
                            {addresses.length === 0 ? (
                                <div className="text-center py-8">
                                    ...
                                    <Text variant="body" className="text-gray-500">Nenhum endereço cadastrado por este cliente.</Text>
                                </div>
                            ) : (
                                    ...
                                    {addresses.map((address) => (
                                        ...
                                        >
                                            <div className="flex justify-between items-start mb-2">
                                                ...
                                                {address.isDefault && (
                                                    <span className="text-[10px] font-bold uppercase tracking-wider bg-primary-600 text-white px-1.5 py-0.5 rounded">Padrão</span>
                                                )}
                                            </div>
